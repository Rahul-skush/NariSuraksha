    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        ...
        <ul>
          <li class="active"><a href="../../templates/landing.php">Home</a></li> 
                ...
                <li><a href="../../templates/ngoregister.php">Register Organisation</a></li>
                <li><a href="../../templates/profile.php">Your Profile</a></li>
      ...
      <button style='border:3px solid #000000;border-radius:8px 0px 8px 0px;'><a href='admin.php?logout='1''><b  style='color:#006494;font-size:15px;'>Logout FROM ADMIN Pannel</b></a>  </button>
        ";
          };
          ?>
